...
<template>
    <div>
        <button v-if="as == 'button'" type="submit" class="block w-full px-4 py-2 text-sm leading-5 text-gray-400 text-left focus:outline-none transition border-0 first-item">
            <slot />
        </button>
